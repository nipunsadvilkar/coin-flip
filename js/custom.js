...
jQuery(document).ready(function($){
    ...
    $('#coin1').on('click', function(){
        $('.frontmain>img').attr('src','img/heads_trans.png');
        $('.backmain>img').attr('src','img/tails_trans.png');
    });
    ...
    $('#coin4').on('click', function(){
        $('.frontmain>img').attr('src','img/10_heads_trans.png');
        $('.backmain>img').attr('src','img/10_tails_trans.png');
    });
    /*$('#coin5').on('click', function(){
